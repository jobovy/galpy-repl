...
# Install galpy and its dependencies
import pyodide_js
await pyodide_js.loadPackage(["numpy", "scipy", "matplotlib", "astropy", "future", "setuptools","https://www.galpy.org/wheelhouse/galpy-latest-cp310-cp310-emscripten_3_1_6_wasm32.whl"])
# Turn off warnings
import warnings
